...
def parse_flags():
  ...
  all_modes_group.add_argument(
      '--model', type=str, choices=['cnn', 'mlp', 'mobilenet'],
      default='cnn', required=True,
      help='Name of a model architecture. Currently, one of mlp/cnn/mobilenet.')
  all_modes_group.add_argument(
...
def parse_hparams(flag_hparams):
  ...
  hparams = tf.contrib.training.HParams(
      ...
      # examples.
      example_window_seconds=0.32,
      example_hop_seconds=0.16,
